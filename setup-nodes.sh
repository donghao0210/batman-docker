...
# sudo apt update -y && apt install git nano batctl net-tools dnsmasq libnl-genl-3-dev libnl-3-dev network-manager -y
...
sudo apt install batctl iw iptables -y
